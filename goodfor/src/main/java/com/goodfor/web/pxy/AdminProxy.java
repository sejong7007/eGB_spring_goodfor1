...
import com.goodfor.web.admin.Admin;
...
public class AdminProxy extends Proxy {
	...
	public String makeNum() {
		int rNum1 = (int)(Math.random() * 2)+1 ;
		int rNum2 = (int)(Math.random() * 1000) ;
		return String.format("%d%03d",rNum1,rNum2);
	}
	
	public String makeRank() {
		int rRank = (int)(Math.random() * 5)+1 ;
		return String.format("%d",rRank);
	}
	...
	//aid, apw, aname, anum, arank, email, phonenum;
	
	public Admin makeAdmin() {
		return new Admin(makeId(),"1234",makeNames(),makeNum(),makeRank(),makeEmail(),makePhoneNum());
	}
	
	@Transactional
	public void insertAdmin() {
		for(int i=0 ; i<10 ; i++) {
			adMapper.insertAdmin(makeAdmin());
		}
	}
